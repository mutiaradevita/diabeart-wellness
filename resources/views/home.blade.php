<x-home-layout>
    <div class="grid w-full h-[135vh] bg-kuning pt-14">
        ...
        <div class="grid w-full h-screen flex-grow bg-hijaut">
            <div class="relative">
        ...
        <div class="flex w-full h-screen flex-grow bg-kuning">
            
        </div>
        <div class="flex w-full h-screen flex-grow bg-hijaut">
